...
export default function BookingsPage() {
  ...
  const { mutateAsync: cancelBookingMutation, isPending: isCanceling } = useCancelHotelBooking();
  ...
  const handleCancelBooking = async () => {
    ...
    try {
      await cancelBookingMutation(cancelBooking.id);
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <div className="text-2xl font-bold text-active">
                    ${booking.rooms * booking.hotel.price * (new Date(booking.check_out_date).getTime() - new Date(booking.check_in_date).getTime()) / 86400000}
                  </div>
                  <div
            ...
            <AlertDialogDescription>
              ...
              {cancelBooking && (
                <div className="mt-4 p-4 text-primary/70 rounded-lg" style={{ backgroundImage: "url(/logo/hero-bg.png)" }}>
                  ...
                  <div><strong>Dates:</strong> {format(new Date(cancelBooking.check_in_date), "dd/MM/yyyy")} - {format(new Date(cancelBooking.check_out_date), "dd/MM/yyyy")}</div>
                </div>
              )}
            </AlertDialogDescription>
          </AlertDialogHeader>
